...
<template>
  <n-modal v-model:show="show" preset="card" style="width: 600px; max-width: 100%"
    :title='t("translate.rename.title")'>
    <template #header>
      <n-space align="center">
        <n-image height="75" :src="getRemoteImgPath(store.eventsCollectionMeta?.thumb!)"/>
